...
gcc bin_gen.c
sudo ./a.out
rm weights_1.txt weights_2.txt weights_3.txt weights_4.txt samples.txt #instruction.txt
...
#sudo iceprog -o "${ADDRESS[4]}" -n to_flash/instruction.bin # write instruction
...
sudo rm read.w4
#sudo iceprog -o "${ADDRESS[4]}" -R 320 read.instr # read samples
#xxd read.instr >> from_flash/read_instr.txt # binary to hex conversion
#sudo rm read.instr
